...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserMetadata&&(identical(other.hasGrantedInterviewConsent, hasGrantedInterviewConsent) || other.hasGrantedInterviewConsent == hasGrantedInterviewConsent));
}
...
@override
String toString() {
  return 'UserMetadata(hasGrantedInterviewConsent: $hasGrantedInterviewConsent)';
}
...
class _UserMetadata implements UserMetadata {
  const _UserMetadata({required this.hasGrantedInterviewConsent});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UserMetadata&&(identical(other.hasGrantedInterviewConsent, hasGrantedInterviewConsent) || other.hasGrantedInterviewConsent == hasGrantedInterviewConsent));
}
