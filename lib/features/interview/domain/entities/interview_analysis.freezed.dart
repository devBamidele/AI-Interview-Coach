...
mixin _$InterviewAnalysis {
 ...
 String get id; String get status; String get transcript; double get duration; String? get recordingUrl; Metrics get metrics; AIAnalysis? get aiAnalysis;
...
@override
String toString() {
  return 'InterviewAnalysis(id: $id, status: $status, transcript: $transcript, duration: $duration, recordingUrl: $recordingUrl, metrics: $metrics, aiAnalysis: $aiAnalysis)';
}
...
@useResult
$Res call({
 String id, String status, String transcript, double duration, String? recordingUrl, Metrics metrics, AIAnalysis? aiAnalysis
});


$MetricsCopyWith<$Res> get metrics;$AIAnalysisCopyWith<$Res>? get aiAnalysis;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String status,  String transcript,  double duration,  String? recordingUrl,  Metrics metrics,  AIAnalysis? aiAnalysis)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InterviewAnalysis() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String status,  String transcript,  double duration,  String? recordingUrl,  Metrics metrics,  AIAnalysis? aiAnalysis)  $default,) {final _that = this;
switch (_that) {
case _InterviewAnalysis():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String status,  String transcript,  double duration,  String? recordingUrl,  Metrics metrics,  AIAnalysis? aiAnalysis)?  $default,) {final _that = this;
switch (_that) {
case _InterviewAnalysis() when $default != null:
return $default(_that.id,_that.status,_that.transcript,_that.duration,_that.recordingUrl,_that.metrics,_that.aiAnalysis);case _:
  return null;
...
class _InterviewAnalysis implements InterviewAnalysis {
  const _InterviewAnalysis({required this.id, required this.status, required this.transcript, required this.duration, this.recordingUrl, required this.metrics, this.aiAnalysis});
...
@override $MetricsCopyWith<$Res> get metrics;@override $AIAnalysisCopyWith<$Res>? get aiAnalysis;
