...
@override
String toString() {
  return 'InterviewAnalysis(id: $id, userId: $userId, createdAt: $createdAt, status: $status, transcript: $transcript, duration: $duration, recordingUrl: $recordingUrl, metrics: $metrics, aiAnalysis: $aiAnalysis, caseQuestion: $caseQuestion, difficulty: $difficulty, candidateAnswer: $candidateAnswer, caseAnalysis: $caseAnalysis)';
}
...
class _InterviewAnalysis extends InterviewAnalysis {
  const _InterviewAnalysis({required this.id, this.userId, required this.createdAt, required this.status, required this.transcript, required this.duration, this.recordingUrl, required this.metrics, this.aiAnalysis, this.caseQuestion, this.difficulty, this.candidateAnswer, this.caseAnalysis}): super._();
